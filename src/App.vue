  ...
  <div id='app' class='container'>
    ...
    <footer class='container-fluid footer text-left mt-3'>
      <div style='float:right'>
        <a href='https://maerovwork@gmail.com' style='margin-right:10px'>
          <i class='fa fa-envelope-open' aria-hidden='true' style='font-size:20px'></i>
        </a>
        <a href='https://github.com/m4eryk' target='_blank' style='margin-right:10px'>
          <i class='fa fa-github' aria-hidden='true' style='font-size:20px'></i>
        </a>
        <a href='https://www.linkedin.com/in/m4eryk/' target='_blank' style='margin-right:10px'>
