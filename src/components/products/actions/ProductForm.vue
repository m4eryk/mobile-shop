<template>
    <div class="productForm">
        <form id="productCU" @submit="actionProduct" v-if="!loading">
              ...
              <div class="form-group">
                <label for="productSeller">Продавец</label>
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    <label for="isBestProduct">Лучший продукт</label>
                ...
                <div class="col">
                    <div class="form-group">
                      <label for="isTopProduct">Популярность</label>
                ...
                <div class="col">
                  <div class="form-group">
                    <label for="productRating">Рейтинг</label>
                    <input type="password" class="form-control" id="productRating" placeholder="пароль">
                  </div>
                </div>
              </div>
              <div class="form-group">
                <label for="productImage">Картинка</label>
                <input type="text" class="form-control" id="productImage" v-model="product.productImage" placeholder="Ссылка на изоброжение">
              </div>
              <br>
              <button type="submit" class="btn buttonGreen">Сохранить</button>
        </form>
