<template>
  <div class="create-account">
    <form class="form-signup" @submit.prevent="createAccount">
      ...
      <h1 class="h3 mb-3 font-weight-normal">Создание аккаунта</h1>
      <div
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          <input
            ...
            required
          >
          <div class="invalid-feedback">Не валидное имя</div>
        </div>
        <div class="col-md-6 mb-3">
          <input
            type="text"
            ...
            required
          >
          <div class="invalid-feedback">Не валидная фамилия</div>
        </div>
      </div>
      <div class="row">
        <div class="col-md mb-3">
          <input
            ...
            required
          >
          <div class="invalid-feedback">Не верный email</div>
        </div>
      </div>
      <div class="row">
        <div class="col-md mb-3">
          <input
            ...
            required
          >
          <div class="invalid-feedback">Не валидный пароль</div>
        </div>
      </div>
      <button class="btn btn-lg btn-primary btn-block" type="submit">
        <i class="fa fa-spinner fa-spin mr-1" v-if="showLoader"></i>Вход
      </button>
    </form>
  </div>
</template>
